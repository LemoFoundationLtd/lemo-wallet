...
const testStorage = {
    ...
    setItem(k, v) {
        this.memory[k] = copyObj(v)
    },
    getItem(k) {
        return copyObj(this.memory[k])
    },
}
...
describe('create_account', () => {
    it('normal', () => {
        ...
        const a = wallet.createAccount('demoWallet', password)
...
describe('import_mnemonic', () => {
    it('empty_hhh', () => {
        ...
        const name = 'hello'
        const a = wallet.importMnemonic(mnemonic, name, password)
...
describe('import_private', () => {
    it('empty_hhh', () => {
        ...
        const name = 'hhh'
        const a = wallet.importPrivate(priv, name, password)
        console.log(a)
    })
})
// 导出助记词
